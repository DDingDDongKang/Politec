...
public class javaTest_1 {
	...
	public static void main(String[] args) throws FileNotFoundException, ParseException {
		...
		try {
			bw = new BufferedWriter(new FileWriter("C:\\Users\\401-ST05\\Desktop\\male.csv"));// 저장할 위치와 이름 설정// 저장할 파일의 경로와 이름 정하기
			...
			for (List<String> newLine : chosenData) { // newLine 이라는 가상의 리스트를 만들어서 chosenData의 size만큼 돌리겠다.
				...
				} else if (list.get(3).equals("남")) { // list배열에 'Male'이 포함 되있다면
